...
// ============================================================================
// Re-exports from new API layer for backwards compatibility
// ============================================================================

export { apiClient, ApiError, isApiError, getErrorMessage } from "./api/client";
export {
  signup,
  login,
  logout,
...
export { useAuth, useResumes, useJobs, useAnalyses } from "@/hooks";
