  ...
  return (
    <main className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-accent-violet/10 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-accent-emerald/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="card-premium p-8">
          <div className="mb-8 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Start optimizing your resume</p>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-gray-500 text-sm">
            ...
            <Link className="text-accent-gold hover:text-accent-goldLight font-medium" href="/login">
              Sign in
            </Link>
          </p>
        </div>
